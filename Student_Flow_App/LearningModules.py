...
def update_day_status(request):
    try:
        ...
        update_app_usage(data.get('student_id'))
        # list_of_sub_topics = []
        # for i in student.student_question_details.get(student_info.course_id.course_id+'_'+data.get('subject_id')
        #                                      ).get('week_'+str(data.get('week_number'))
        #                                            ).get('day_'+str(data.get('day_number'))
        #                                                  ).get('sub_topic_status'):
        #     list_of_sub_topics.append(student.student_question_details.get(student_info.course_id.course_id+'_'+data.get('subject_id')
        #                                      ).get('week_'+str(data.get('week_number'))
        #                                            ).get('day_'+str(data.get('day_number'))
        #                                                  ).get('sub_topic_status').get(i))
