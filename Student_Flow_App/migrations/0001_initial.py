# Generated by Django 4.1.13 on 2025-05-28 09:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_catogory', models.CharField(choices=[('SUN', 'SUN'), ('MOON', 'MOON'), ('STAR', 'STAR')], default='--', max_length=20)),
                ...
                ('batch_id', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.batches')),
                ('course_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.courses')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('del_row', models.BooleanField(default=False)),
                ('student_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.students_info')),
                ('trainer_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.trainers')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(blank=True, max_length=100, null=True)),
                ('del_row', models.BooleanField(default=False)),
                ('subject_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Student_Flow_App.subjects')),
            ],
            options={
                'db_table': 'topics',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch_id', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.batches')),
                ('course_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.courses')),
                ('subject_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.subjects')),
                ('track_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.tracks')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='subjects',
            name='track_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Student_Flow_App.tracks'),
        ),
        migrations.CreateModel(
            name='sub_topics',
            fields=[
                ...
                ('action', models.CharField(blank=True, max_length=100, null=True)),
                ('del_row', models.BooleanField(default=False)),
                ('topic_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Student_Flow_App.topics')),
            ],
            options={
                'db_table': 'sub_topics',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.students_info')),
                ('subject_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.subjects')),
                ('test_id', models.ForeignKey(db_column='Test_id', on_delete=django.db.models.deletion.CASCADE, to='Student_Flow_App.test_details')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('del_row', models.BooleanField(default=False)),
                ('question_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.questions')),
                ('student_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.students_info')),
                ('subject_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.subjects')),
                ('test_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.test_details')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('del_row', models.BooleanField(default=False)),
                ('activity_subtopic', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.sub_topics')),
                ('activity_topic', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.topics')),
                ('student_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.students_info')),
                ('subject_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.subjects')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='sub_topic_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.sub_topics'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('del_row', models.BooleanField(default=False)),
                ('batch_id', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.batches')),
                ('course_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Student_Flow_App.courses')),
                ('subject_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Student_Flow_App.subjects')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('del_row', models.BooleanField(default=False)),
                ('college_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.college_details')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='batches',
            name='course_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Student_Flow_App.courses'),
        ),
        migrations.CreateModel(
            name='test_sections',
            fields=[
                ...
                ('del_row', models.BooleanField(default=False)),
                ('question_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.questions')),
                ('sub_topic_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.sub_topics')),
                ('test_id', models.ForeignKey(db_column='Test_id', on_delete=django.db.models.deletion.CASCADE, to='Student_Flow_App.test_details')),
                ('topic_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Student_Flow_App.topics')),
            ],
            options={
